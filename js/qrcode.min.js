/**
 * Standalone QRCode Generator for ISP TIC System (Zero CDN Dependency)
 */
(function(global) {
    ...
    function QRPolynomialImpl(num, shift) {
    ...
    QRPolynomialImpl.prototype = {
        ...
        multiply: function(e) {
            ...
            return new QRPolynomialImpl(num, 0);
        },
        mod: function(e) {
            ...
            return new QRPolynomialImpl(num, 0).mod(e);
        }
    };
    ...
    var QRUtil = {
        ...
        getErrorCorrectPolynomial: function(errorCorrectLength) {
            var a = new QRPolynomialImpl([1], 0);
            for (var i = 0; i < errorCorrectLength; i++) {
                a = a.multiply(new QRPolynomialImpl([1, QRPolynomial.gexp(i)], 0));
            }
            return a;
        },
    ...
    QRCodeModel.prototype = {
        ...
        getBestMaskPattern: function() {
            ...
            for (var i = 0; i < 8; i++) {
                ...
                var lostPoint = QRUtil.getLostPoint ? QRUtil.getLostPoint(this) : 0;
    ...
    QRCodeModel.createBytes = function(buffer, rsBlocks) {
        ...
        for (var r = 0; r < rsBlocks.length; r++) {
            ...
            var rawPoly = new QRPolynomialImpl(dcdata[r], rsPoly.getLength() - 1);
    ...
    /**
     * Standalone QRCode API
     */
    var QRCode = function(target, options) {
